...
factory('AUTHfactory',function(LSfactory, SSfactory){
    ...
    AUTH = {
        ...
        isAuthorizedAuthor: function () {
            var authority = this.getSessionUser().authorized;
            if (authority == 'author' || authority == 'tutor' || authority == 'admin') {
                
                return true;
            }
            return false;
        },
        isAuthorizedTutor: function () {
            if (this.getSessionUser().authorized == 'tutor') {
